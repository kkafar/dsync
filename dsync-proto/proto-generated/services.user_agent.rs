...
pub struct HostSpec {
    #[prost(oneof = "host_spec::Inner", tags = "1, 2, 3")]
    pub inner: ::core::option::Option<host_spec::Inner>,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PathSpec {
    #[prost(oneof = "path_spec::Inner", tags = "1, 2")]
    pub inner: ::core::option::Option<path_spec::Inner>,
}
/// Nested message and enum types in `PathSpec`.
pub mod path_spec {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Inner {
        #[prost(string, tag = "1")]
...
pub struct FileSourceSpec {
    ...
    pub path_spec: ::core::option::Option<PathSpec>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct FileCopyRequest {
    #[prost(message, optional, tag = "1")]
    pub src_spec: ::core::option::Option<FileSourceSpec>,
    #[prost(message, optional, tag = "2")]
    pub dst_spec: ::core::option::Option<FileSourceSpec>,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
