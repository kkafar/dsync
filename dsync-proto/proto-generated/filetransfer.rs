...
pub struct TransferSubmitFileMetadata {}
/// *
...
pub struct TransferSubmitRequest {
    ...
    #[prost(string, tag = "1")]
    pub host_org_uuid: ::prost::alloc::string::String,
    /// *
    /// UUID of Destination Host; where the file is to be transmitted to.
    #[prost(string, tag = "2")]
    pub host_dst_uuid: ::prost::alloc::string::String,
    /// *
    ...
    #[prost(string, tag = "4")]
    pub file_path_dst: ::prost::alloc::string::String,
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub mod file_transfer_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn transfer_submit(
            &mut self,
            request: impl tonic::IntoRequest<super::TransferSubmitRequest>,
        ) -> std::result::Result<
            tonic::Response<super::TransferSubmitResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod file_transfer_service_server {
    ...
    pub trait FileTransferService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn transfer_submit(
            &self,
            request: tonic::Request<super::TransferSubmitRequest>,
        ) -> std::result::Result<
            tonic::Response<super::TransferSubmitResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/filetransfer.FileTransferService/TransferSubmit" => {
                    ...
                    impl<
                        T: FileTransferService,
                    > tonic::server::UnaryService<super::TransferSubmitRequest>
                    for TransferSubmitSvc<T> {
                        type Response = super::TransferSubmitResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as FileTransferService>::transfer_submit(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = TransferSubmitSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
