...
pub mod file_transfer_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn init_transfer(
            &mut self,
            request: impl tonic::IntoRequest<super::InitTransferRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InitTransferResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/filetransfer.FileTransferService/InitTransfer",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("filetransfer.FileTransferService", "InitTransfer"),
                );
...
pub mod file_transfer_service_server {
    ...
    pub trait FileTransferService: std::marker::Send + std::marker::Sync + 'static {
        async fn init_transfer(
            &self,
            request: tonic::Request<super::InitTransferRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InitTransferResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/filetransfer.FileTransferService/InitTransfer" => {
                    ...
                    struct InitTransferSvc<T: FileTransferService>(pub Arc<T>);
                    impl<
                        T: FileTransferService,
                    > tonic::server::UnaryService<super::InitTransferRequest>
                    for InitTransferSvc<T> {
                        type Response = super::InitTransferResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as FileTransferService>::init_transfer(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = InitTransferSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
